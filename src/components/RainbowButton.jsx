...
const RainbowButton = ({ children, className, onClick, href, ...props }) => {
  return (
    ...
    <button
      ...
      className={cn(
        ...
        // Before styles for the rainbow effect
      ...
      {...props}  // Spread other props to ensure proper handling of additional attributes like disabled, etc.
    >
      {children}
    </button>
  );
