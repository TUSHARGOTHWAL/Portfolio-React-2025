    ...
    >
      <g clipPath="url(#path0)">
        ...
        <circle
          ...
          cy="25"
          r="6"
          className="fill-[#E5E5E5] dark:fill-[#db0b0b]"
        />
        <circle
          cx="47"
          cy="25"
          r="6"
          className="fill-[#E5E5E5] dark:fill-[#f5f242]"
        />
        <circle
          cx="67"
          cy="25"
          r="6"
          className="fill-[#E5E5E5] dark:fill-[#10a100]"
        />
        <path
        ...
        {/* Continue with other paths and elements... */}
        {imageSrc && (
          <image
            href={imageSrc}
            cover="fill"
